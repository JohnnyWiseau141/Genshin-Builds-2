        ...
        <>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link to='/' className="btn btn-ghost normal-case text-xl">Genshin Builds</Link>
                </div>
                ...
                {/* Conditionally render user's profile or Login Signup buttons here. */}
                <div className="navbar-end">
                    <Link to='/login' className="btn btn-ghost mx-4">Login</Link>
